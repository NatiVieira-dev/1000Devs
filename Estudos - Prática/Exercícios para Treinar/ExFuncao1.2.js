...
function main() 
{
    ...
    console.log("Área do Retângulo: " + calcularAreaRetangulo (base, altura)); //////////uso de funcao que retorna valor
    ...
    console.log("Área do Círculo: " + calcularAreaCirculo (raio)); //////////uso de funcao que retorna valor
    ...
    console.log("Área do Triângulo: " + calcularAreaTriangulo (base, altura)); //////////uso de funcao que retorna valor
}
